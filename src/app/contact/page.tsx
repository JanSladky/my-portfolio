    ...
    <div className="bg-[#e9f0fb] min-h-screen w-full pt-[120px] pb-20 px-4 font-sans antialiased">
      <div className="max-w-4xl mx-auto backdrop-blur-2xl bg-white/10 border border-white/30 rounded-3xl shadow-2xl ring-1 ring-white/10 p-10">
        ...
        <div className="flex justify-center mb-8 gap-4">
          <button onClick={() => setActiveTab('client')} className={`btn-glass font-semibold ${activeTab === 'client' ? 'tab-btn-glass' : 'btn-primary-light'}`}>
            <span className="btn-primary-inner">Poptávka na web</span>
          </button>
          <button onClick={() => setActiveTab('company')} className={`btn-glass font-semibold ${activeTab === 'company' ? 'tab-btn-glass' : 'btn-primary-light'}`}>
