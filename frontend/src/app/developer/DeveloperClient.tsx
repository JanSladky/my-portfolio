...
export default function DeveloperClient({ data }: Props) {
  const { title, cv_section_title, cv_name, cv_birth_date, cv_mail, cv_tel_number, work_section_title, work_experiences, education_section_title, education_experiences } = data;
    ...
    <div className="w-full min-h-screen bg-[#e9f0fb] text-[#1f2937] pt-[120px] pb-[60px]">
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        ...
        <section className="mb-12">
          <h2 className="text-xl sm:text-2xl font-semibold border-b-2 border-blue-500 w-fit pb-1 mb-6">Životopis</h2>
